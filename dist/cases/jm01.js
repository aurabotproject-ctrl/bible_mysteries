...
const JM01_THEORIES = [
  {
    ...
    answer:"j01charge",
    verdict:"The charge sheet closes it. A mistake is something you did not know you were doing. Look at what the garden record actually shows: <b>one</b> command, clearly given; the penalty stated in advance, so nobody was tricked; the command broken anyway; and then — the tell — they <i>hid</i>, and each blamed somebody else. Nobody hides from an honest mistake. That is a charge, with a law and a price attached, and the people it was laid against knew it was real before anybody else said so. You do not need a religious word for it. Something is owed, and they knew it was owed at the time."
  },
  {
    id:"deeds",
...
const CASE_JM01 = {
  ...
  teacher:{
    ...
    pairs:"There was never a debt → The Charge, As Laid; good deeds cancel it → The Account, As Found; religion clears it → Three Who Came to the Door; I am better than most → The Audit; it will be overlooked → The Price Set Against It.",
