...
const JM47_LOCKS = [
  {
    ...
    hints:[
      ...
      "Count the plans (5). Count the two marked 'spoken only' (2). Count the councillors (6). The king says in not one of the five did they so much as see an Israelite (0)."
    ],
