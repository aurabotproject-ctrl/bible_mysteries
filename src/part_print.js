...
function printPack(cdef){
  ...
  <section class="pp-page">
    <div class="pp-h">Before you play — preparing the pack</div>
    ...
    <div class="pp-step"><b>2</b><div><h5>Remove the answer key</h5>
      <p>The last page is the answer key, for whoever is running the case. Take it out before anything else, or the case is over before it starts.</p></div></div>
    ...
    <div class="pp-note"><b>Time:</b> 60–100 minutes, or two sittings. <b>Teams of two or three.</b> Any more and somebody stops reading.</div>
  </section>
  ...
  <section class="pp-page">
    ...
    ${step(9,"Close the case",
      `<p>Whoever is running the case checks the board and dates the certificate. Put the certificate, your case record and anything else you want to keep into your case folder.</p>`)}
  </section>
...
function folderPack(){
  ...
  const html = `<div class="ppdoc">
    <section class="pp-page pp-cover">
      ...
      <p class="pp-teaser" style="margin-top:26px">Every case you finish adds three things to this folder: the case record in your own handwriting, the certificate signed off at the end, and whatever evidence you decide is worth keeping. Case by case it becomes the record of everything you worked out.</p>
