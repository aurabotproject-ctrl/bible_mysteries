...
function printPack(cdef){
  ...
  <section class="pp-page">
    ...
    ${step(9,"Close the case",
      `<p>Whoever is running the case checks the board and signs the certificate. Put the certificate, your case record and anything else you want to keep into your case folder.</p>`)}
  </section>
