...
*A garden, then a hill · Genesis 3 to the empty tomb · `#8c2f2a` · payment test*

Image prompts for this case, ready to paste. Generate each one, save it in
this folder under the file name given, then drop it into `investigate/images/`
and rebuild — the case picks it up by file name with nothing else to change.
...
## A word before you generate these

This is the one case in the archive where the artwork carries something other
than evidence, and it is worth being deliberate about it.

- **Nothing gruesome, and no bodies on crosses.** Every prompt below shows the
  place, the object or the aftermath. A Year 7 class will be looking at these
  on a screen with no warning, and the case does not need horror to land — the
  ledger does that work.
- **No faces, and no depiction of Jesus.** Partly the house style (no people
  unless asked for), partly because a drawn face invites a class to argue about
  the face instead of the file. The empty middle cross says more.
- **Restraint reads as weight here.** The temptation on this case is golden
  light and rays. Resist it. The rest of the archive is a quiet, dusty,
  evidence-room world, and this case is more powerful for being in the same
  room as the others rather than suddenly in a stained-glass window.

---

## Poster — save as `poster_jm01.jpg`

> Hand-drawn antique illustration on aged cream parchment, in the manner of a 19th-century archaeological field plate. Sepia, ochre, tan and faded ink-brown palette with muted olive-green accents. Fine pen cross-hatching and light watercolour wash. Visible paper grain, foxing spots, softly worn deckled edges. No people. Wide landscape format, 3:2. A dramatic single image for a case poster. An old accounting ledger lying open on a dark wooden desk, its ruled columns densely filled with illegible handwritten entries in faded iron-gall ink, column after column of debts. Across the lower right of the page, pressed heavily over the writing, a large deep-red wax seal, cracked at the edges, bearing the simple impression of a plain cross. A stub of red sealing wax and a brass hand-seal lie beside it. Warm raking lamplight from the upper left. No people. Absolutely no text, letters, numbers or writing that could be read anywhere in the image — the handwriting must be pure illegible scribble. Bold, simple composition that reads clearly at small size. Wide landscape format, 3:2.

---

## Plate — the place, outside the wall — save as `j01hill.jpg`

> Hand-drawn antique illustration on aged cream parchment, in the manner of a 19th-century archaeological field plate. Sepia, ochre, tan and faded ink-brown palette with muted olive-green accents. Fine pen cross-hatching and light watercolour wash. Visible paper grain, foxing spots, softly worn deckled edges. No people. Wide landscape format, 3:2. A bare rocky hill outside a city wall at first light, seen from a distance across open stony ground. On the crown of the hill stand three empty wooden crosses — the centre one noticeably taller than the two beside it. All three are bare and unoccupied. No figures of any kind, no ropes, no blood, nothing hanging from them. The city wall runs low along the left horizon. Long soft dawn shadows fall towards the viewer. Add three blank rectangular label plaques with thin dark borders and empty cream interiors, each connected by a fine leader line with a small dot to one of the main features. The plaques must be completely blank. Absolutely no text, letters, numbers or writing anywhere in the image.
...
## Before you hand the folder back
...
- **3:2 landscape**, 1536 × 1024, for everything except the seal.
- **Say "no text" twice**, and for the ledger plates say "illegible scribble"
  as well. Image models desperately want to write real words on an account page,
  and a legible number on a ledger will start an argument in class about what it
  says.
- **Check the crosses come out empty.** This is the one prompt in the archive
  where a model is likely to add a figure you did not ask for. If it does, add
  *"the crosses are bare and empty, no figures at all"* and generate again.
